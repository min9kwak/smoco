...
from configs.mixup import MixUpConfig
...
from datasets.brain import BrainProcessor, Brain, BrainMixUp
...
def main_worker(local_rank: int, config: object):
    ...
    if config.enable_wandb:
        wandb.init(
            ...
            project=f'sttr-{config.task}-mixup',
    ...
    train_set = BrainMixUp(dataset=datasets['train'], data_type=config.data_type,
                           transform=train_transform, alpha=config.alpha)
