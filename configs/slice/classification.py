...
class SliceClassificationConfig(object):
    ...
    def task_specific_parser() -> argparse.ArgumentParser:
        parser = argparse.ArgumentParser('SliceClassification', add_help=False)
    ...
    def model_parser() -> argparse.ArgumentParser:
        ...
        parser.add_argument('--backbone_type', type=str, default='resnet50',
                            choices=('resnet18', 'resnet50', 'wide28_2'))
    ...
    def logging_parser() -> argparse.ArgumentParser:
        ...
        parser.add_argument('--save_every', type=int, default=1000, help='Save model checkpoint every `save_every` epochs.')
