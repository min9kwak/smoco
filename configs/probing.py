...
class ProbingConfig(object):
    ...
    def finetune_parser() -> argparse.ArgumentParser:
        """Returns an `argparse.ArgumentParser` instance containing logging-related arguments."""
        parser = argparse.ArgumentParser("Probing", add_help=False)
        ...
        parser.add_argument('--finetune_trans', type=str, choices=('train', 'test'), default='test')
        parser.add_argument('--target_name', type=str)
        parser.add_argument('--loss_function', type=str, choices=('ce', 'mse', 'mae'))
        return parser
